    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>놓칠 수 없는 서울의 명소</figcaption>
        </figure>
      </div>
      <!-- ################################################################################################ --> 
      <%-- class="current" --%>
      ...
      <nav class="pagination">
        <ul>
          <c:if test="${startPage>1 }">
            <li><a href="../seoul/seoul_location.do?page=${startPage-1 }">&laquo;</a></li>
          </c:if>
          ...
          <c:forEach var="i" begin="${startPage }" end="${endPage }">
            ...
            <li ${style }><a href="../seoul/seoul_location.do?page=${i }">${i }</a></li>
          </c:forEach>
          <c:if test="${endPage<totalpage }">
            <li><a href="../seoul/seoul_location.do?page=${endPage+1 }">&raquo;</a></li>
          </c:if>
        </ul>
      </nav>
      <!-- ################################################################################################ --> 
